...
function GiveMissmatch() {
    ...
    const handleEmailSend = async(e) =>{
        ...
        try {
            ...
            Swal.fire({
                icon:'success',
                title:'Giveaway Email sent successfully',
            })
    ...
    return (
        <MainLayout>
            <div className="max-w-lg bg-white shadow-lg mx-auto p-7 rounded mt-6">
                <h2 className="font-semibold text-xl mb-4 text-center block">Send Giveaway missmatch</h2>
